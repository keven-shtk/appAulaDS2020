...
if(!$conexao){
    $dados = array(
        'tipo' => 'info',
        'mesagem' => 'OPS, não foi possível obter uma conexão com o banco de dados, tente mais tarde...'
    );
} else{
...
echo json_encode($dados, JSON_UNESCAPED_SLSHES | JSON_UNESCAPED_UNICODE);